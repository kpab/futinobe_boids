...
sim.add_start_position(470, 430, False)
sim.add_start_position(470, 420, False) 
sim.add_start_position(470, 410, False) 
sim.add_start_position(470, 400, False) 
sim.add_start_position(470, 390, False) 
...
# 階段(右)
sim.add_goal(470, 440, 0.1, True)
sim.add_goal(470, 430, 0.1, True)
sim.add_goal(470, 420, 0.1, True)
sim.add_goal(470, 410, 0.1, True) 
sim.add_goal(470, 400, 0.1, True) 
sim.add_goal(470, 390, 0.1, True) 
sim.add_goal(470, 380, 0.1, True) 
